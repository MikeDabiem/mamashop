...
<?php } else { ?>
    ...
    <div class="cart-menu__footer">
        ...
        <p class="cart-menu__footer--error error-free font-11-13 fw-400 <?php $cart_total >= 250 ? print 'show' : null; ?>">При замовленні на суму більше 500 грн доставка безкоштовна</p>
