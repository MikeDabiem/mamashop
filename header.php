...
//            }
            ...
            <div class="cart-menu__products">
                ...
                <div class="cart-menu__products__item d-flex">
                    <a href="#" class="item-image img-wrapper-cover d-block">
                        <img src="<?php bloginfo('template_url'); ?>/images/eye-slash.svg" alt="">
                    </a>
                    <div class="item__info">
                        <div class="item__info__top d-flex justify-content-between">
                            <div class="item__name">
                                <a href="#" class="item__name-title font-13-16 fw-500 d-block">Плин для посуду Ultra nature</a>
                                <a href="#" class="item__name-subtitle font-12-16 fw-500 d-block">Denkmit</a>
                            </div>
                            <button class="delete-item align-self-start">
                        ...
                        <div class="item__info__bottom d-flex justify-content-between">
                            <div class="item__qty d-flex align-items-center">
                                <button id="qty_minus" class="item__qty-button" disabled></button>
                                <input type="number" class="item__qty-num font-14-20 fw-500" value="1" disabled>
                                <button id="qty_plus" class="item__qty-button"></button>
                            </div>
                            <div class="item__price">
                                <div class="item__price__discount">
                                    <span class="item__price__discount-value font-9-11 fw-400 text-decoration-line-through">180 грн</span>
                                    <span class="item__price__discount-percent font-11-13 fw-600">-25%</span>
                                </div>
                                <p class="item__price-value font-15-18 fw-600 text-end">105 грн</p>
                            </div>
                        </div>
                    </div>
                </div>
